            ...
            <div className="container-custom py-0">
                <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="flex items-center gap-2 group">
                        <img src="/makerpro-logo-para-fundo-escuro.webp" alt="MAKEPRO" className="h-8 md:h-32 w-auto object-contain transform scale-150 origin-left" width="128" height="128" />
                    </a>
